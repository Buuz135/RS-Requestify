...
public class CraftingEmitterContainer extends AbstractResourceContainerMenu implements ExportingIndicatorListener {
    ...
    public CraftingEmitterContainer(final int syncId, final Player player, final CraftingEmitterBlockEntity blockEntity, final ResourceContainer exportConfig, final ExportingIndicators indicators) {
        super(RSRContent.Menus.CRAFTING_EMITTER.get(), syncId, player);
    ...
    public CraftingEmitterContainer(final int syncId,
                                    final Inventory playerInventory,
                                    final CraftingEmitterData interfaceData) {
        super(RSRContent.Menus.CRAFTING_EMITTER.get(), syncId);
    ...
    private Slot createExportConfigSlot(final ResourceContainer exportConfig, final int index) {
        ...
        return new ResourceSlot(
                exportConfig,
                index,
                Component.translatable("block.rsrequestify.crafting_emitter.tooltip.filter"),
                x,
